...
class CouponIssueRedisServiceTest extends TestConfig {
    ...
    void availableTotalIssueQuantity_2(){
        ...
        long couponId = 1;
        /**
         * IntStream.range()를 통하여 redis에 전체 쿠폰 발급 수량만큼 dummy 데이터를 생성한다.
         */
    ...
    @Test
    @DisplayName("쿠폰 중복 발급 검증 - 발급 내역에 유저가 존재하지 않으면 True를 반환")
    ...
    @Test
    @DisplayName("쿠폰 중복 발급 검증 - 발급 내역에 유저가 존재하면 false를 반환")
